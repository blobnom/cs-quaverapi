...
namespace QuaverAPI
{
    public class QuaverAPI
    {
        ...
        public async Task<Structures.ServerStats> GetServerStatsAsync()
        {
        ...
        public async Task<Structures.UserData> GetUserAsync(int id)
        {
        ...
        public async Task<List<Structures.UserInfo>> SearchUsersAsync(string name)
        {
        ...
        public async Task<List<Structures.Rank>> GetUserRankGraphAsync(int id, int mode)
        {
        ...
        public async Task<List<Structures.Achievement>> GetUserAchievementsAsync(int id)
        {
        ...
        public async Task<List<Structures.Mapset>> GetUserMapsetsAsync(int id)
        {
        ...
        public async Task<Structures.Map> GetMapAsync(int id)
        {
        ...
        public async Task<Structures.Mapset> GetMapsetAsync(int id)
        {
        ...
        public async Task<List<Structures.Score>> GetUserRecentAsync(int id, int mode)
        {
        ...
        public async Task<List<Structures.Score>> GetUserBestAsync(int id, int mode)
        {
        ...
        public async Task<List<Structures.Score>> GetUserFirstPlaceAsync(int id, int mode)
        {
        ...
        public async Task<List<Structures.MapScore>> GetMapScoresAsync(int id)
        {
